"""
File name: N2O_emission_script_farm_5.py
Author: Ida Marie Blok Nielsen
Date: December 9, 2025
Course: RnD project

Description:
    This script is used to calculate N2O emission from danish cattle barns for farm_5 by using
...
dates = ["20240816", "20240817", "20240818"]
valves = [1, 2, 3, 7, 8]
valve_labels = {1: "Background East field", 2: "Background East tank", 3: "Barn sampling",
                7: "Background West tank", 8: "Background West field"}
farm_name = "farm_5"
...
# input parameters
wind_file = "../data/DMI/farm_5_DMI.csv"
start_time = "2024-08-16 00:00:00"
stop_time = "2024-08-18 23:00:00"
print(wind_file)
