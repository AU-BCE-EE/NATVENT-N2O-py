"""
File name: N2O_emission_script_farm_1_w.py
Author: Ida Marie Blok Nielsen
Date: Decemebr 9, 2025
Course: RnD project

Description:
    This script is used to calculate N2O emission from danish cattle barns for 
    (farm_1_w, where w means that the measurements were taken in the winter period) by using
...
dates = ["20241129", "20241130", "202401201"]
valves = [1, 3, 7, 8]
valve_labels = {1: "Background North", 3: "Barn sampling",
