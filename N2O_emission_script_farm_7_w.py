"""
File name: N2O_emission_script_farm_7_w.py
...
Description:
    ...
    (farm_7_w, where w means that the measurements were taken in the winter period) by using
...
dates = ["20250228", "20250301", "20250302"]
valves = [1, 2, 3, 7, 8]
valve_labels = {1: "Background North", 2: "Background Southwest", 3: "Barn sampling",
                7: "Background South", 8: "Background Southeast"}
farm_name = "farm_7_w"
...
# input parameters
wind_file = "../data/DMI/farm_7_DMI.csv"
start_time = "2025-02-28 00:00:00"
stop_time = "2025-03-02 23:00:00"
print(wind_file)
