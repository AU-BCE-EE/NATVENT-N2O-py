"""
File name: N2O_emission_script_farm_6.py
Author: Ida Marie Blok Nielsen
Date: December 9, 2025
Course: RnD project

Description:
    This script is used to calculate N2O emission from danish cattle barns for farm_6 by using
...
dates = ["20250711", "20250712", "20250713"]
valves = [1, 2, 3, 7, 8]
valve_labels = {1: "Background West", 2: "Background South (field)", 3: "Barn sampling",
                7: "Background East (tank)", 8: "Background North (wall)"}
farm_name = "farm_6"
...
# input parameters
wind_file = "../data/DMI/farm_6_DMI.csv"
start_time = "2025-07-11 00:00:00"
stop_time = "2025-07-13 23:00:00"
print(wind_file)
