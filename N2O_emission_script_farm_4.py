"""
File name: N2O_emission_script_farm_4.py
Author: Ida Marie Blok Nielsen
Date: December 9, 2025
Course: RnD project

Description:
    This script is used to calculate N2O emission from danish cattle barns for farm_4 by using
