"""
File name: N2O_emission_script_farm_2_w.py
...
Description:
    ...
    (farm_2_w, where w means that the measurements were taken in the winter period) by using
...
dates = ["20250110", "20250111", "20250112"]
valves = [3, 7, 8]
