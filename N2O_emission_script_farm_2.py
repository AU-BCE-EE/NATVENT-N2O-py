"""
File name: N2O_emission_script_farm_2.py
...
Description:
    ...
    farm_2 by using the module "N2O_emission_for_all_farms.py" to process and visualize data.
...
dates = ["20240904", "20240905", "20240906"]
valves = [3, 7, 8]
valve_labels = {3: "Barn sampling",
                7: "Background North", 8: "Background South"}
farm_name = "farm_2"
...
# input parameters
wind_file = "../data/DMI/farm_2_DMI.csv"
start_time = "2024-09-04 00:00:00"
stop_time = "2024-09-06 23:00:00"
print(wind_file)
