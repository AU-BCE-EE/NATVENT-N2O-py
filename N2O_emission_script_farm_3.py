"""
File name: N2O_emission_script_farm_3.py
...
Description:
    ...
    farm_3 by using the module "N2O_emission_for_all_farms.py" to process and visualize data.
...
dates = ["20250620", "20250621", "20250622"]
valves = [1, 3, 7, 8]
