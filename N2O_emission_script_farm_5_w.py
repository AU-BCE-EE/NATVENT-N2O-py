"""
File name: N2O_emission_script_farm_5_w.py
...
Description:
    ...
    (farm_5_w, where w means that the measurements were taken in the winter period) by using
...
dates = ["20250115", "20250116", "20250117"]
valves = [1, 2, 3, 7, 8]
valve_labels = {1: "Background East field", 2: "Background East tank", 3: "Barn sampling",
                7: "Background West field", 8: "Background West tank"}
farm_name = "farm_5_w"
