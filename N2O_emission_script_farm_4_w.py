"""
File name: N2O_emission_script_farm_4_w.py
...
Description:
    ...
    (farm_4_w, where w means that the measurements were taken in the winter period) by using
...
dates = ["20250214", "20250215", "20250216"]
valves = [3, 7, 8]
valve_labels = {3: "Barn sampling",
                7: "Background East", 8: "Background West"}
farm_name = "farm_4_w"
...
# input parameters
wind_file = "../data/DMI/farm_4_DMI.csv"
start_time = "2025-02-14 00:00:00"
stop_time = "2025-02-16 23:00:00"
print(wind_file)
