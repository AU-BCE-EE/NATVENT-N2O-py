"""
File name: N2O_emission_script_farm_6_w.py
...
Description:
    ...
    (farm_6_w, where w means that the measurements were taken in the winter period) by using
...
dates = ["20241213", "20241214", "20241215"]
valves = [1, 2, 3, 7, 8]
valve_labels = {1: "Background West", 2: "Background South (field)", 3: "Barn sampling",
                7: "Background North (wall)", 8: "Background East (tank)"}
farm_name = "farm_6_w"
